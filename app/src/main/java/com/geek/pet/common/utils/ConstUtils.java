...
public class ConstUtils {
     ...
     */
    public static final String REGEX_PASSWORD = "^(?![A-Z]+$)(?![a-z]+$)(?!\\d+$)(?![\\W_]+$)\\S{6,16}$";
    /**
     * 正则：密码(简单)，取值范围为含有小写字母、大写字母、数字的两种及以上,必须是6-12位
     */
    public static final String REGEX_PASSWORD_SIMPLE = "^(?![A-Z]+$)(?![a-z]+$)(?!\\d+$)\\S{6,12}$";
    /**
