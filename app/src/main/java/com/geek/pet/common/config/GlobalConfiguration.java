package com.geek.pet.common.config;
...
import com.geek.pet.BuildConfig;
...
//                    RetrofitUrlManager.getInstance().with(okhttpBuilder);
    ...
    public void injectAppLifecycle(Context context, List<AppLifecycles> lifecycles) {
        ...
        // 可以根据不同的逻辑添加多个实现类
//        RetrofitUrlManager.getInstance().putDomain(VetorApi.VETOR_DOMAIN_NAME, VetorApi.VETOR_URL);
