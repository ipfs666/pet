...
public class AdaptiveViewGroup extends ViewGroup {
    ...
    public void chooseItemStyle(int pos) {
        ...
        if (pos < getChildCount()) {
            ...
            childView.setBackgroundResource(R.drawable.shape_btn_frame_yellow);
        }
    }
    ...
    private void clearItemsStyle() {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            childView.setBackgroundResource(R.drawable.shape_btn_frame_gray);
        }
    }
